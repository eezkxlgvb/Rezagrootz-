...
# ========== تنظیمات ==========
BOT_TOKEN = "8698104560:AAEeQP0ukSVwiMmcX_aA3KgPrpHJ5W0N6ds"
...
# ========== کلاس دیتابیس پیشرفته با قفل ==========
class AdvancedDatabase:
    def __init__(self, db_file='bot_data.db'):
        self.conn = sqlite3.connect(db_file, check_same_thread=False)
        self.conn.row_factory = sqlite3.Row
        self.cursor = self.conn.cursor()
        self.lock = threading.Lock()  # قفل برای همگام‌سازی تردها
        self._create_tables()
        self._migrate()
...
def main_menu():
    ...
    keyboard.add(
        InlineKeyboardButton("⚙️ تنظیمات", callback_data="settings", style="primary"),
        InlineKeyboardButton("📊 آمار", callback_data="stats", style="primary"),
        InlineKeyboardButton("📋 قوانین", callback_data="rules", style="primary"),
        InlineKeyboardButton("🏆 رنکینگ", callback_data="ranking", style="primary"),
        InlineKeyboardButton("🎫 تیکت", callback_data="tickets", style="primary"),
        InlineKeyboardButton("👤 پروفایل", callback_data="profile", style="primary"),
        InlineKeyboardButton("🆘 راهنما", callback_data="help", style="primary"),
        InlineKeyboardButton("🔄 بروزرسانی", callback_data="refresh", style="primary"),
        InlineKeyboardButton("🚨 گزارش تخلف", callback_data="report", style="danger"),
        InlineKeyboardButton("🔒 امنیت", callback_data="security_panel", style="primary"),
        InlineKeyboardButton("📝 مدیریت", callback_data="admin_panel", style="primary"),
        InlineKeyboardButton("🎁 پاداش روزانه", callback_data="daily_reward", style="success"),
        InlineKeyboardButton("🏅 مسابقات", callback_data="contests", style="primary"),
        InlineKeyboardButton("👥 مدیریت ادمین‌ها", callback_data="admin_management", style="primary"),
        InlineKeyboardButton("📌 فیلتر کلمات", callback_data="word_filter", style="primary"),
        InlineKeyboardButton("🕒 پیام زمان‌بندی", callback_data="scheduled_messages", style="primary"),
        InlineKeyboardButton("📝 یادداشت کاربر", callback_data="user_notes", style="primary"),
        InlineKeyboardButton("🧠 AI تشخیص اسپم", callback_data="ai_settings", style="primary")
    )
    return keyboard
...
def settings_menu(group_id):
    keyboard = InlineKeyboardMarkup(row_width=2)
    keyboard.add(
        InlineKeyboardButton("🔰 پایه", callback_data=f"basic_{group_id}", style="primary"),
        InlineKeyboardButton("🛡️ ضد اسپم", callback_data=f"spam_{group_id}", style="primary"),
        InlineKeyboardButton("🚫 محدودیت‌ها", callback_data=f"restrict_{group_id}", style="primary"),
        InlineKeyboardButton("🔐 امنیت", callback_data=f"security_{group_id}", style="primary"),
        InlineKeyboardButton("🎯 پیشرفته", callback_data=f"advanced_{group_id}", style="primary"),
        InlineKeyboardButton("🤖 پاسخ خودکار", callback_data=f"autoreply_{group_id}", style="primary"),
        InlineKeyboardButton("📝 قوانین", callback_data=f"rules_edit_{group_id}", style="primary"),
        InlineKeyboardButton("📋 لیست‌ها", callback_data=f"lists_{group_id}", style="primary"),
        InlineKeyboardButton("🌟 فوق‌پیشرفته", callback_data=f"ultra_{group_id}", style="primary"),
        InlineKeyboardButton("🧠 AI & ML", callback_data=f"ai_{group_id}", style="primary"),
...
def basic_settings_menu(group_id):
    ...
    keyboard.add(
        InlineKeyboardButton(f"{'✅' if settings['welcome_enabled'] else '❌'} پیام خوش‌آمدگویی", callback_data=f"toggle_welcome_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['captcha'] else '❌'} کپچا", callback_data=f"toggle_captcha_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['auto_delete'] else '❌'} حذف خودکار", callback_data=f"toggle_autodelete_{group_id}", style="primary"),
        InlineKeyboardButton("⏱️ تنظیم زمان حذف", callback_data=f"autodel_set_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['daily_reward'] else '❌'} پاداش روزانه", callback_data=f"toggle_daily_reward_{group_id}", style="primary"),
        InlineKeyboardButton("🔙 بازگشت", callback_data=f"back_settings_{group_id}", style="primary")
    )
    return keyboard
...
def spam_settings_menu(group_id):
    ...
    keyboard = InlineKeyboardMarkup(row_width=1)
    keyboard.add(
        InlineKeyboardButton(f"{'✅' if settings['anti_spam'] else '❌'} ضد اسپم", callback_data=f"toggle_antispam_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_spam_bayesian'] else '❌'} تشخیص بیزین", callback_data=f"toggle_bayesian_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_raid'] else '❌'} ضد رید", callback_data=f"toggle_antiraid_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['duplicate_message_detection'] else '❌'} تشخیص پیام تکراری", callback_data=f"toggle_duplicate_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['ai_spam_detection'] else '❌'} تشخیص هوشمند (AI)", callback_data=f"toggle_ai_spam_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_channel_spam'] else '❌'} ضد اسپم کانال", callback_data=f"toggle_channel_spam_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_reply_spam'] else '❌'} ضد ریپلای اسپم", callback_data=f"toggle_reply_spam_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_hashtag_spam'] else '❌'} ضد هشتگ اسپم", callback_data=f"toggle_hashtag_spam_{group_id}", style="primary"),
        InlineKeyboardButton("🔙 بازگشت", callback_data=f"back_settings_{group_id}", style="primary")
    )
    return keyboard
...
def restrict_settings_menu(group_id):
    ...
    keyboard = InlineKeyboardMarkup(row_width=1)
    keyboard.add(
        InlineKeyboardButton(f"{'✅' if settings['anti_mentions'] else '❌'} ضد منشن", callback_data=f"toggle_mentions_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_caps'] else '❌'} ضد کپس", callback_data=f"toggle_caps_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_emoji'] else '❌'} ضد ایموجی", callback_data=f"toggle_emoji_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_newlines'] else '❌'} ضد خط جدید", callback_data=f"toggle_newlines_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_forward'] else '❌'} ضد فوروارد", callback_data=f"toggle_forward_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_repeat_char'] else '❌'} ضد تکرار کاراکتر", callback_data=f"toggle_repeat_char_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_emoji_spam'] else '❌'} ضد ایموجی اسپم", callback_data=f"toggle_emoji_spam_{group_id}", style="primary"),
        InlineKeyboardButton("🔙 بازگشت", callback_data=f"back_settings_{group_id}", style="primary")
    )
    return keyboard
...
def security_settings_menu(group_id):
    ...
    keyboard = InlineKeyboardMarkup(row_width=1)
    keyboard.add(
        InlineKeyboardButton(f"{'✅' if settings['anti_bot'] else '❌'} ضد ربات", callback_data=f"toggle_bot_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_link'] else '❌'} ضد لینک", callback_data=f"toggle_link_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_bad_words'] else '❌'} ضد فحش", callback_data=f"toggle_badwords_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_advertising'] else '❌'} ضد تبلیغات", callback_data=f"toggle_advert_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['two_factor_auth'] else '❌'} تأیید دو مرحله‌ای", callback_data=f"toggle_2fa_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_ghost'] else '❌'} ضد حساب شبح", callback_data=f"toggle_ghost_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_invite'] else '❌'} ضد دعوت‌نامه", callback_data=f"toggle_invite_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_token'] else '❌'} ضد توکن", callback_data=f"toggle_token_{group_id}", style="primary"),
        InlineKeyboardButton("🔙 بازگشت", callback_data=f"back_settings_{group_id}", style="primary")
    )
    return keyboard
...
def advanced_settings_menu(group_id):
    settings = udb.get_group(group_id)
    keyboard = InlineKeyboardMarkup(row_width=1)
    # این بخش بسیار طولانی است، برای اختصار فقط چند نمونه را نشان می‌دهیم.
    # اما در کد واقعی تمام دکمه‌ها باید به‌روز شوند.
    keyboard.add(
        InlineKeyboardButton(f"{'✅' if settings['anti_porn'] else '❌'} ضد محتوای بزرگسالان", callback_data=f"toggle_porn_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_violence'] else '❌'} ضد خشونت", callback_data=f"toggle_violence_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_drugs'] else '❌'} ضد مواد مخدر", callback_data=f"toggle_drugs_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_hate'] else '❌'} ضد نفرت", callback_data=f"toggle_hate_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_phishing'] else '❌'} ضد فیشینگ", callback_data=f"toggle_phishing_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_malware'] else '❌'} ضد بدافزار", callback_data=f"toggle_malware_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_terrorism'] else '❌'} ضد تروریسم", callback_data=f"toggle_terrorism_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_child_abuse'] else '❌'} ضد آزار کودکان", callback_data=f"toggle_childabuse_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_crypto'] else '❌'} ضد کلاهبرداری رمزارز", callback_data=f"toggle_crypto_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_gambling'] else '❌'} ضد قمار", callback_data=f"toggle_gambling_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_url_shortener'] else '❌'} ضد لینک کوتاه", callback_data=f"toggle_shortener_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_phone'] else '❌'} ضد شماره تلفن", callback_data=f"toggle_phone_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_email'] else '❌'} ضد ایمیل", callback_data=f"toggle_email_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_self_harm'] else '❌'} ضد خودآزاری", callback_data=f"toggle_selfharm_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_bullying'] else '❌'} ضد قلدری", callback_data=f"toggle_bullying_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_doxxing'] else '❌'} ضد داکسینگ", callback_data=f"toggle_doxxing_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_impersonation'] else '❌'} ضد جعل هویت", callback_data=f"toggle_impersonation_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_scam'] else '❌'} ضد کلاهبرداری", callback_data=f"toggle_scam_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_payment'] else '❌'} ضد پرداخت", callback_data=f"toggle_payment_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_self_promo'] else '❌'} ضد خودتبلیغی", callback_data=f"toggle_selfpromo_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_clickbait'] else '❌'} ضد کلیک‌بیت", callback_data=f"toggle_clickbait_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_fake_news'] else '❌'} ضد اخبار جعلی", callback_data=f"toggle_fakenews_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_social_media'] else '❌'} ضد شبکه‌های اجتماعی", callback_data=f"toggle_socialmedia_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_torrent'] else '❌'} ضد تورنت", callback_data=f"toggle_torrent_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_warez'] else '❌'} ضد کرک", callback_data=f"toggle_warez_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_spoof'] else '❌'} ضد دامنه جعلی", callback_data=f"toggle_spoof_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_pharma'] else '❌'} ضد دارو", callback_data=f"toggle_pharma_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_gore'] else '❌'} ضد محتوای خشن", callback_data=f"toggle_gore_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_abuse'] else '❌'} ضد فحاشی", callback_data=f"toggle_abuse_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_harassment'] else '❌'} ضد آزار", callback_data=f"toggle_harassment_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_stalking'] else '❌'} ضد تعقیب", callback_data=f"toggle_stalking_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_blackmail'] else '❌'} ضد باج‌خواهی", callback_data=f"toggle_blackmail_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_sexting'] else '❌'} ضد سکس‌تینگ", callback_data=f"toggle_sexting_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_cyberbullying'] else '❌'} ضد قلدری سایبری", callback_data=f"toggle_cyberbullying_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_discrimination'] else '❌'} ضد تبعیض", callback_data=f"toggle_discrimination_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_hate_speech'] else '❌'} ضد سخن نفرت‌انگیز", callback_data=f"toggle_hatespeech_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_extremism'] else '❌'} ضد افراط‌گرایی", callback_data=f"toggle_extremism_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_radicalization'] else '❌'} ضد رادیکال‌سازی", callback_data=f"toggle_radicalization_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_cults'] else '❌'} ضد فرقه", callback_data=f"toggle_cults_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_satanism'] else '❌'} ضد شیطان‌پرستی", callback_data=f"toggle_satanism_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_occult'] else '❌'} ضد علوم غریبه", callback_data=f"toggle_occult_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_conspiracy'] else '❌'} ضد توطئه", callback_data=f"toggle_conspiracy_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_misinformation'] else '❌'} ضد اطلاعات نادرست", callback_data=f"toggle_misinformation_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_fraud'] else '❌'} ضد کلاهبرداری مالی", callback_data=f"toggle_fraud_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_plagiarism'] else '❌'} ضد سرقت ادبی", callback_data=f"toggle_plagiarism_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_vpn'] else '❌'} ضد VPN", callback_data=f"toggle_vpn_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_tor'] else '❌'} ضد Tor", callback_data=f"toggle_tor_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_i2p'] else '❌'} ضد I2P", callback_data=f"toggle_i2p_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_freenet'] else '❌'} ضد Freenet", callback_data=f"toggle_freenet_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_zeronet'] else '❌'} ضد ZeroNet", callback_data=f"toggle_zeronet_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_mastodon'] else '❌'} ضد Mastodon", callback_data=f"toggle_mastodon_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_diaspora'] else '❌'} ضد Diaspora", callback_data=f"toggle_diaspora_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_minds'] else '❌'} ضد Minds", callback_data=f"toggle_minds_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_gab'] else '❌'} ضد Gab", callback_data=f"toggle_gab_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_parler'] else '❌'} ضد Parler", callback_data=f"toggle_parler_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_truth'] else '❌'} ضد Truth", callback_data=f"toggle_truth_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_gettr'] else '❌'} ضد Gettr", callback_data=f"toggle_gettr_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_rumble'] else '❌'} ضد Rumble", callback_data=f"toggle_rumble_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_odysee'] else '❌'} ضد Odysee", callback_data=f"toggle_odysee_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_bitchute'] else '❌'} ضد Bitchute", callback_data=f"toggle_bitchute_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_dtube'] else '❌'} ضد Dtube", callback_data=f"toggle_dtube_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_peertube'] else '❌'} ضد Peertube", callback_data=f"toggle_peertube_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_lbry'] else '❌'} ضد Lbry", callback_data=f"toggle_lbry_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_steemit'] else '❌'} ضد Steemit", callback_data=f"toggle_steemit_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_hive'] else '❌'} ضد Hive", callback_data=f"toggle_hive_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_blurt'] else '❌'} ضد Blurt", callback_data=f"toggle_blurt_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_whaleshares'] else '❌'} ضد Whaleshares", callback_data=f"toggle_whaleshares_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_busy'] else '❌'} ضد Busy", callback_data=f"toggle_busy_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_partiko'] else '❌'} ضد Partiko", callback_data=f"toggle_partiko_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_actifit'] else '❌'} ضد Actifit", callback_data=f"toggle_actifit_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_sportstalk'] else '❌'} ضد Sportstalk", callback_data=f"toggle_sportstalk_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_weku'] else '❌'} ضد Weku", callback_data=f"toggle_weku_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_social'] else '❌'} ضد Social", callback_data=f"toggle_social_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_musing'] else '❌'} ضد Musing", callback_data=f"toggle_musing_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_dlike'] else '❌'} ضد Dlike", callback_data=f"toggle_dlike_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_triplea'] else '❌'} ضد TripleA", callback_data=f"toggle_triplea_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_splinterlands'] else '❌'} ضد Splinterlands", callback_data=f"toggle_splinterlands_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_risingstar'] else '❌'} ضد Risingstar", callback_data=f"toggle_risingstar_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_dcity'] else '❌'} ضد Dcity", callback_data=f"toggle_dcity_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_cryptobrewmaster'] else '❌'} ضد Cryptobrewmaster", callback_data=f"toggle_cryptobrewmaster_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_splintertalk'] else '❌'} ضد Splintertalk", callback_data=f"toggle_splintertalk_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_terracore'] else '❌'} ضد Terracore", callback_data=f"toggle_terracore_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_holybread'] else '❌'} ضد Holybread", callback_data=f"toggle_holybread_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_crpt'] else '❌'} ضد Crpt", callback_data=f"toggle_crpt_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_oneup'] else '❌'} ضد Oneup", callback_data=f"toggle_oneup_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_battle'] else '❌'} ضد Battle", callback_data=f"toggle_battle_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_legion'] else '❌'} ضد Legion", callback_data=f"toggle_legion_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_empire'] else '❌'} ضد Empire", callback_data=f"toggle_empire_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_kingdom'] else '❌'} ضد Kingdom", callback_data=f"toggle_kingdom_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_planet'] else '❌'} ضد Planet", callback_data=f"toggle_planet_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_galaxy'] else '❌'} ضد Galaxy", callback_data=f"toggle_galaxy_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_universe'] else '❌'} ضد Universe", callback_data=f"toggle_universe_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_cosmos'] else '❌'} ضد Cosmos", callback_data=f"toggle_cosmos_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_nebula'] else '❌'} ضد Nebula", callback_data=f"toggle_nebula_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_star'] else '❌'} ضد Star", callback_data=f"toggle_star_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_moon'] else '❌'} ضد Moon", callback_data=f"toggle_moon_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_sun'] else '❌'} ضد Sun", callback_data=f"toggle_sun_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_earth'] else '❌'} ضد Earth", callback_data=f"toggle_earth_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_water'] else '❌'} ضد Water", callback_data=f"toggle_water_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_fire'] else '❌'} ضد Fire", callback_data=f"toggle_fire_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_air'] else '❌'} ضد Air", callback_data=f"toggle_air_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_space'] else '❌'} ضد Space", callback_data=f"toggle_space_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_time'] else '❌'} ضد Time", callback_data=f"toggle_time_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_dimension'] else '❌'} ضد Dimension", callback_data=f"toggle_dimension_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_parallel'] else '❌'} ضد Parallel", callback_data=f"toggle_parallel_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_multiverse'] else '❌'} ضد Multiverse", callback_data=f"toggle_multiverse_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_omniverse'] else '❌'} ضد Omniverse", callback_data=f"toggle_omniverse_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_void'] else '❌'} ضد Void", callback_data=f"toggle_void_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_eternity'] else '❌'} ضد Eternity", callback_data=f"toggle_eternity_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_infinity'] else '❌'} ضد Infinity", callback_data=f"toggle_infinity_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['anti_absolute'] else '❌'} ضد Absolute", callback_data=f"toggle_absolute_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['auto_moderate'] else '❌'} خودکار", callback_data=f"toggle_automod_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'🔒' if settings['group_lock'] else '🔓'} قفل گروه", callback_data=f"toggle_lock_{group_id}", style="danger" if settings['group_lock'] else "primary"),
        InlineKeyboardButton(f"{'🔇' if settings['silent_mode'] else '🔊'} حالت سکوت", callback_data=f"toggle_silent_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['leveling'] else '❌'} سیستم سطح", callback_data=f"toggle_level_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'🔒' if settings['button_access_locked'] else '🔓'} دسترسی دکمه‌ها", callback_data=f"toggle_button_access_{group_id}", style="primary"),
        InlineKeyboardButton("🔙 بازگشت", callback_data=f"back_settings_{group_id}", style="primary")
    )
    return keyboard
...
def ultra_settings_menu(group_id):
    ...
    keyboard = InlineKeyboardMarkup(row_width=1)
    keyboard.add(
        InlineKeyboardButton(f"{'✅' if settings['auto_ban_on_three_warnings'] else '❌'} بن بعد از ۳ اخطار", callback_data=f"toggle_auto_ban_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['auto_backup'] else '❌'} بکاپ خودکار", callback_data=f"toggle_autobackup_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['scan_media'] else '❌'} اسکن رسانه", callback_data=f"toggle_scanmedia_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['auto_report_to_admins'] else '❌'} گزارش خودکار به ادمین", callback_data=f"toggle_autoreport_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['auto_kick_inactive'] else '❌'} اخراج کاربران غیرفعال", callback_data=f"toggle_inactive_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['approval_required'] else '❌'} تأیید ورود", callback_data=f"toggle_approval_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['log_chat'] else '❌'} لاگ چت", callback_data=f"toggle_logchat_{group_id}", style="primary"),
        InlineKeyboardButton(f"{'✅' if settings['welcome_dm'] else '❌'} خوش‌آمدگویی خصوصی", callback_data=f"toggle_welcomedm_{group_id}", style="primary"),
        InlineKeyboardButton(f"📊 سطح حساسیت: {settings['sensitivity_level']}", callback_data=f"set_sensitivity_{group_id}", style="primary"),
        InlineKeyboardButton("🔙 بازگشت", callback_data=f"back_settings_{group_id}", style="primary")
    )
    return keyboard
...
def ai_settings_menu(group_id):
    ...
    keyboard = InlineKeyboardMarkup(row_width=1)
    keyboard.add(
        InlineKeyboardButton(f"{'✅' if settings['ai_spam_detection'] else '❌'} تشخیص اسپم با AI", callback_data=f"toggle_ai_spam_{group_id}", style="primary"),
        InlineKeyboardButton("📊 آموزش مدل", callback_data=f"train_ai_{group_id}", style="primary"),
        InlineKeyboardButton("📋 آمار تشخیص", callback_data=f"ai_stats_{group_id}", style="primary"),
        InlineKeyboardButton("🔙 بازگشت", callback_data=f"back_settings_{group_id}", style="primary")
    )
    return keyboard
...
def autoreply_menu(group_id):
    keyboard = InlineKeyboardMarkup(row_width=1)
    keyboard.add(
        InlineKeyboardButton("➕ افزودن پاسخ خودکار", callback_data=f"add_autoreply_{group_id}", style="primary"),
        InlineKeyboardButton("📋 لیست پاسخ‌ها", callback_data=f"list_autoreply_{group_id}", style="primary"),
        InlineKeyboardButton("🔙 بازگشت", callback_data=f"back_settings_{group_id}", style="primary")
    )
    return keyboard
...
def lists_menu(group_id):
    keyboard = InlineKeyboardMarkup(row_width=1)
    keyboard.add(
        InlineKeyboardButton("📋 لیست سیاه", callback_data=f"blacklist_{group_id}", style="danger"),
        InlineKeyboardButton("📋 لیست سفید", callback_data=f"whitelist_{group_id}", style="success"),
        InlineKeyboardButton("📋 گزارش‌ها", callback_data=f"reports_{group_id}", style="primary"),
        InlineKeyboardButton("📋 فیلتر کلمات", callback_data=f"word_filter_{group_id}", style="primary"),
        InlineKeyboardButton("🔙 بازگشت", callback_data=f"back_settings_{group_id}", style="primary")
    )
    return keyboard
...
def auto_delete_menu(group_id):
    keyboard = InlineKeyboardMarkup(row_width=2)
    keyboard.add(
        InlineKeyboardButton("⏱️ ۱ ساعت", callback_data=f"autodel_set_{group_id}_3600", style="primary"),
        InlineKeyboardButton("⏱️ ۶ ساعت", callback_data=f"autodel_set_{group_id}_21600", style="primary"),
        InlineKeyboardButton("⏱️ ۱۲ ساعت", callback_data=f"autodel_set_{group_id}_43200", style="primary"),
        InlineKeyboardButton("⏱️ ۲۴ ساعت", callback_data=f"autodel_set_{group_id}_86400", style="primary"),
        InlineKeyboardButton("❌ غیرفعال", callback_data=f"autodel_set_{group_id}_0", style="danger"),
        InlineKeyboardButton("🔙 بازگشت", callback_data=f"back_settings_{group_id}", style="primary")
    )
    return keyboard
...
def contest_menu(group_id):
    keyboard = InlineKeyboardMarkup(row_width=1)
    keyboard.add(
        InlineKeyboardButton("➕ مسابقه جدید", callback_data=f"new_contest_{group_id}", style="primary"),
        InlineKeyboardButton("📋 مسابقات فعال", callback_data=f"list_contests_{group_id}", style="primary"),
        InlineKeyboardButton("🔙 بازگشت", callback_data="back_main", style="primary")
    )
    return keyboard
...
def admin_management_menu(group_id):
    keyboard = InlineKeyboardMarkup(row_width=1)
    keyboard.add(
        InlineKeyboardButton("➕ افزودن ادمین", callback_data=f"add_admin_{group_id}", style="primary"),
        InlineKeyboardButton("➖ حذف ادمین", callback_data=f"remove_admin_{group_id}", style="danger"),
        InlineKeyboardButton("📋 لیست ادمین‌ها", callback_data=f"list_admins_{group_id}", style="primary"),
        InlineKeyboardButton("📢 منشن همه", callback_data=f"mention_all_{group_id}", style="primary"),
        InlineKeyboardButton("🔙 بازگشت", callback_data="back_main", style="primary")
    )
    return keyboard
...
def word_filter_menu(group_id):
    keyboard = InlineKeyboardMarkup(row_width=1)
    keyboard.add(
        InlineKeyboardButton("➕ افزودن کلمه", callback_data=f"add_wordfilter_{group_id}", style="primary"),
        InlineKeyboardButton("📋 لیست کلمات", callback_data=f"list_wordfilter_{group_id}", style="primary"),
        InlineKeyboardButton("❌ حذف کلمه", callback_data=f"remove_wordfilter_{group_id}", style="danger"),
        InlineKeyboardButton("🔙 بازگشت", callback_data="back_main", style="primary")
    )
    return keyboard
...
def scheduled_messages_menu(group_id):
    keyboard = InlineKeyboardMarkup(row_width=1)
    keyboard.add(
        InlineKeyboardButton("➕ افزودن پیام زمان‌بندی", callback_data=f"add_scheduled_{group_id}", style="primary"),
        InlineKeyboardButton("📋 لیست پیام‌ها", callback_data=f"list_scheduled_{group_id}", style="primary"),
        InlineKeyboardButton("🔙 بازگشت", callback_data="back_main", style="primary")
    )
    return keyboard
...
def user_notes_menu(group_id):
    keyboard = InlineKeyboardMarkup(row_width=1)
    keyboard.add(
        InlineKeyboardButton("➕ افزودن یادداشت", callback_data=f"add_usernote_{group_id}", style="primary"),
        InlineKeyboardButton("📋 یادداشت‌های کاربر", callback_data=f"list_usernotes_{group_id}", style="primary"),
        InlineKeyboardButton("🔙 بازگشت", callback_data="back_main", style="primary")
    )
    return keyboard
...
def back_button():
    ...
    keyboard.add(InlineKeyboardButton("🔙 بازگشت", callback_data="back_main", style="primary"))
    return keyboard
...
def poll_command(message):
    ...
    for i, opt in enumerate(options):
        # دکمه‌های گزینه‌ها را با style primary می‌سازیم
        keyboard.add(InlineKeyboardButton(opt, callback_data=f"poll_vote_{poll_id}_{i}", style="primary"))
    keyboard.add(InlineKeyboardButton("🔒 بستن نظرسنجی", callback_data=f"poll_close_{poll_id}", style="danger"))
